...
**How to use it**. Ask yourself the question. 'What is the first principle of SOLID?' in our case. Then answer it. Since you are answering it for the first time, we will consider it a "first contact" /"memorization" / you get it. Paint blue the intersection between today's date and this question.

Let's suppose you created two more questions. "Lifecycle methods in React" and "How list virtualization works". You also answer them out loud, and paint the rectangle blue.

That's all. You _got familiar_ with the information.

## Next day.

You sit down looking at the spreadsheet and start answering each question. For the first question about SOLID, you answered more or less alright, but not so well. Paint yellow the cell in the spreadsheet. You answered the second one about Lifecycle methods really well, paint it green. And the question about virtualization went really bad, you've forgotten what it is at all. Paint it red.
