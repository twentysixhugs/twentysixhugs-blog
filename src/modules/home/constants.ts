...
export const HEADING_TYPED_AFTER = TYPING_DELAY * INTRODUCTION_HEADING.length;

export const APPEAR_KEYFRAMES_LENGTH = 1000;
export const APPEAR_KEYFRAMES_ADDITIONAL_DELAY = 0;
